...
/*
 * The application the client is generated for: core with the audit and admin plugins, so their routes
 * join the OpenAPI document and the client's `audit` and `admin` namespaces. Nothing here is served;
