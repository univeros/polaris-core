...
/*
 * The application the client is generated for: core with the audit, admin and sentinel plugins, so their
 * routes join the OpenAPI document and the client's `audit`, `admin` and `sentinel` namespaces. Nothing here is served;
...
return new Config(
    ...
    plugins: [new AuditPlugin(), new AdminPlugin(), new SentinelPlugin()],
);
