...
/** The RFC 9457 problem document every non-2xx response of a plugin route (`audit`, `admin`) carries. */
 ...
 * are also methods of `client.audit` and `client.admin`. No refresh loop and no storage: when to refresh
